...
namespace Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        {
            return View(_productsRepository.GetAllProduct().ToList());
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var product = _productsRepository.GetProductById(id.Value);
        ...
        public async Task<IActionResult> Delete(int? id)
        {
            ...
            var orderDetails = _productsRepository.GetProductById(id.Value);
